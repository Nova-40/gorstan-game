 ...
 * Generated based on room descriptions, items, NPCs, and atmospheric details
 */

export const roomMiniquests: RoomMiniquests[] = [
  // Elfhame Zone Miniquests
  {
    roomId: 'faeglade',
    miniquests: [
      {
