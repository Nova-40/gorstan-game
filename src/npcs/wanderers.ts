  ...
  conversation: [
    {
      ...
      responses: [
        ...
        {
          text: "What do you mean by unpredictable elements?",
          nextId: "morthos_concern",
        },
      ],
    },
    {
      ...
      responses: [
        ...
        {
          text: "Why should I trust bureaucracy over mystery?",
          nextId: "bureaucracy_defense",
        },
        {
          text: "Maybe I should hear both sides.",
          nextId: "diplomatic_response",
        },
      ],
    },
    {
      ...
      responses: [
        {
          text: "That sounds very practical. I'm interested.",
          nextId: "ally_accept",
        },
        {
          text: "What would you need from me in return?",
          nextId: "al_requirements",
        },
        {
          text: "How do I know you're really in charge here?",
          nextId: "authority_proof",
        },
    ...
    },
    {
      ...
      responses: [
        ...
        {
          text: "Thank you for trusting me with this role.",
          nextId: "grateful_ally",
        },
      ],
    },
    {
      ...
      responses: [
        ...
        {
          text: "I still want to hear what Morthos has to say.",
          nextId: "stubborn_neutral",
        },
        {
          text: "What if there's truth in both approaches?",
          nextId: "synthesis_attempt",
        },
      ],
    },
    {
      ...
      responses: [
        ...
        {
          text: "What's wrong with ignoring some protocols?",
          nextId: "protocol_defense",
        },
      ],
    },
    {
      ...
      responses: [
        {
          text: "You're absolutely right. Order is important.",
          nextId: "order_convert",
        },
        {
          text: "But don't some situations require flexibility?",
          nextId: "flexibility_debate",
        },
        {
    ...
    },
    {
      ...
      responses: [
        {
          text: "That sounds much safer than Morthos's approach.",
          nextId: "safety_priority",
        },
        {
          text: "But is safety worth limiting potential?",
          nextId: "safety_vs_growth",
        },
        {
          text: "Morthos, how do you respond to that?",
          nextId: "await_morthos_counter",
        },
        {
          text: "Can you two find any common ground?",
          nextId: "mediation_attempt",
        },
      ],
    },
    {
      ...
      responses: [
        {
          text: "Al makes a good point about safety records.",
          nextId: "support_al_logic",
        },
        {
          text: "Seventeen collapses? That sounds serious.",
          nextId: "collapse_details",
        },
        {
          text: "Morthos, what's your counter-argument?",
          nextId: "morthos_rebuttal_prompt",
        },
        {
          text: "This is fascinating. Keep debating.",
          nextId: "encourage_debate",
        },
      ],
    },
    {
      ...
      responses: [
        ...
        {
          text: "Morthos, do you agree with Al's suggestion?",
          nextId: "morthos_compromise_check",
        },
        {
          text: "What would a compromise look like practically?",
          nextId: "compromise_details",
        },
        {
    ...
    },
    {
      ...
      responses: [
        {
          text: "Al, explain your methodologies.",
          nextId: "methodology_explanation",
        },
        {
        ...
        {
          text: "What's your assessment of Morthos's approach?",
          nextId: "al_vs_morthos",
        },
        {
          text: "Can't you both work together instead of competing?",
          nextId: "cooperation_plea",
        },
      ],
    },
    {
      ...
      responses: [
        {
          text: "I respect your dedication to order.",
          nextId: "order_respect",
        },
        {
          text: "But isn't some risk necessary for growth?",
          nextId: "risk_necessity",
        },
        {
        ...
        {
          text: "You two really don't like each other, do you?",
          nextId: "acknowledge_rivalry",
        },
      ],
    },
    {
      ...
      responses: [
        {
          text: "Sustainable results sound important.",
          nextId: "sustainability_value",
        },
        {
          text: "What kind of instabilities has Morthos caused?",
          nextId: "morthos_disasters",
        },
        { text: "Morthos, is what Al says true?", nextId: "truth_challenge" },
        {
          text: "You both have different strengths.",
          nextId: "diplomatic_observation",
        },
      ],
    },
  ],
  ...
  conversation: [
    {
      ...
      responses: [
        {
          text: "I'm trying to understand this place.",
          nextId: "understanding",
        },
        { text: "Who are you exactly?", nextId: "identity" },
        {
          text: 'What do you mean by "recruitment speech"?',
          nextId: "recruitment_rivalry",
        },
        {
          text: "What can you offer that Al can't?",
          nextId: "morthos_benefits",
        },
    ...
    },
    {
      ...
      responses: [
        {
          text: "That sounds incredible. Tell me more.",
          nextId: "morthos_pitch",
        },
        {
          text: "How is that different from what Al offers?",
          nextId: "compare_approaches",
        },
        {
          text: "What would you require from me?",
          nextId: "morthos_requirements",
        },
        {
          text: "Both of you are trying to recruit me?",
          nextId: "competition_acknowledgment",
        },
      ],
    },
    {
      ...
      responses: [
        {
          text: "I want to learn these powers. Teach me.",
          nextId: "accept_morthos",
        },
        {
          text: "That sounds dangerous. What's the catch?",
          nextId: "power_cost",
        },
        {
          text: "How do I know you're telling the truth?",
          nextId: "prove_power",
        },
        {
          text: "Why are you and Al competing for allies?",
          nextId: "reveal_conflict",
        },
      ],
    },
    {
      ...
      responses: [
        {
          text: "I accept your offer. Make me your student.",
          nextId: "alliance_morthos",
        },
        { text: "What exactly would I be learning?", nextId: "curriculum" },
        {
          text: "This sounds too good to be true.",
          nextId: "skeptical_response",
        },
    ...
    },
    {
      ...
      responses: [
        ...
        {
          text: "How will this affect my relationship with Al?",
          nextId: "al_reaction",
        },
        {
          text: "I feel... different. Is this normal?",
          nextId: "transformation_effects",
        },
      ],
    },
    {
      ...
      responses: [
        {
          text: "I choose wings and risk over safety.",
          nextId: "embrace_chaos",
        },
        {
          text: "Sometimes safety is more important than freedom.",
          nextId: "safety_argument",
        },
        {
          text: "Can't I have both safety and freedom?",
          nextId: "balance_attempt",
        },
      ],
    },
    {
      ...
      responses: [
        ...
        {
          text: "Why the pressure? That makes me suspicious.",
          nextId: "pressure_suspicion",
        },
      ],
    },
    {
      ...
      responses: [
        ...
        {
          text: "Why should I trust Polly over Ayla?",
          nextId: "polly_vs_ayla",
        },
        {
          text: "You're trying to manipulate me too.",
          nextId: "manipulation_accusation",
        },
    ...
    },
    {
      ...
      responses: [
        {
          text: "How can I tell if you're being truthful?",
          nextId: "truth_test",
        },
        { text: "What does she want from me?", nextId: "ayla_agenda" },
        {
          text: "If that's true, why are you telling me?",
          nextId: "morthos_motive",
        },
      ],
    },
    {
      ...
      responses: [
        ...
        {
          text: "What about Al? Your thoughts on him?",
          nextId: "al_assessment",
        },
      ],
    },
    {
      ...
      responses: [
        {
          text: "I want to hear both of your arguments.",
          nextId: "formal_debate",
        },
        {
          text: "Why are you two fighting over me?",
          nextId: "competition_explanation",
        },
        {
          text: "What if I choose neither of you?",
          nextId: "independence_choice",
        },
        {
          text: "Can't you two work together?",
          nextId: "cooperation_suggestion",
        },
      ],
    },
    {
      ...
      responses: [
        ...
        {
          text: "Actually, Morthos, you go first.",
          nextId: "morthos_formal_pitch",
        },
        {
          text: "I want to hear you debate each other.",
          nextId: "competitive_debate",
        },
      ],
    },
    {
      ...
      responses: [
        {
          text: "Al, how do you respond to that?",
          nextId: "await_al_response",
        },
        {
          text: "This is getting heated. Maybe we should calm down.",
          nextId: "mediation_attempt",
        },
        {
          text: "Keep going. I want to see where this leads.",
          nextId: "encourage_conflict",
        },
      ],
    },
  ],
  ...
  conversation: [
    {
      ...
      responses: [
        ...
        {
          text: "How long have you been exploring here?",
          nextId: "experience",
        },
    ...
    },
    {
      ...
      responses: [
        ...
        {
          text: "How do you find these hidden areas?",
          nextId: "finding_secrets",
        },
        {
          text: "Are there any dangerous secret areas?",
          nextId: "danger_secrets",
        },
      ],
    },
    {
...
export const wendell: NPC = {
  ...
  conversation: [
    ...
    },
    {
      ...
      responses: [
        ...
        {
          text: "Is that why strange things happen here?",
          nextId: "strange_events",
        },
        {
          text: "Have you discovered anything important?",
          nextId: "discoveries",
        },
      ],
    },
    ...
    },
    {
      ...
      responses: [
        {
          text: "What was she saying about reality barriers?",
          nextId: "reality_barriers",
        },
        { text: "You seem really absorbed in this topic.", nextId: "passion" },
        {
          text: "Are there other good books on this subject?",
          nextId: "recommendations",
        },
      ],
    },
  ],
  ...
  customResponses: {
    thanks:
      "*nods warmly* Think nothing of it! Knowledge shared is knowledge multiplied.",
    goodbye:
...
export const dominic: NPC = {
  ...
  conversation: [
    {
      ...
      responses: [
        {
          text: "Just exploring and trying to figure things out.",
          nextId: "exploring",
        },
    ...
    },
    {
      ...
      responses: [
        ...
        {
          text: "Any specific areas I should check out?",
          nextId: "recommendations",
        },
    ...
    },
    {
      ...
      responses: [
        {
          text: "Do you want to go back to your old life?",
          nextId: "return_home",
        },
        {
          text: "What kind of trouble do people get into?",
          nextId: "common_troubles",
        },
  ...
  topics: [
    {
      ...
      response:
        "Always happy to lend a hand. What kind of situation are you dealing with?",
    },
    {
  ...
  customResponses: {
    thanks:
      "No problem at all! We gotta look out for each other in a place like this.",
