...
export class GroupChatManager {
  ...
  static triggerAlliancePitch(context: GroupChatContext): void {
    ...
    dispatch({
      type: "SET_FLAG",
      payload: { flag: "alliancePitchStarted", value: true },
    });
  ...
  static presentAllianceChoice(context: GroupChatContext): void {
    ...
    dispatch({
      type: "SET_FLAG",
      payload: { flag: "awaitingAllianceChoice", value: true },
    });
  }
  ...
  static processAllianceChoice(
    ...
    if (
      lowerChoice.includes("ally morthos") ||
      lowerChoice.includes("choose morthos")
    ) {
      // Player chooses Morthos
      dispatch({
        type: "SET_FLAG",
        payload: { flag: "playerAlliance", value: "morthos" },
      });
      dispatch({
        type: "SET_FLAG",
        payload: { flag: "allianceChosen", value: true },
      });
      dispatch({
        type: "SET_FLAG",
        payload: { flag: "awaitingAllianceChoice", value: false },
      });
      ...
      lowerChoice.includes("ally al") ||
      lowerChoice.includes("choose al")
    ) {
      // Player chooses Al
      dispatch({
        type: "SET_FLAG",
        payload: { flag: "playerAlliance", value: "al" },
      });
      dispatch({
        type: "SET_FLAG",
        payload: { flag: "allianceChosen", value: true },
      ...
      dispatch({
        type: "SET_FLAG",
        payload: { flag: "playerAlliance", value: "neutral" },
      });
      dispatch({
        type: "SET_FLAG",
        payload: { flag: "allianceChosen", value: true },
  ...
  static handleMorthosCostInquiry(context: GroupChatContext): void {
    ...
    dispatch({
      type: "SET_FLAG",
      payload: { flag: "morthosCostInquiries", value: costInquiries },
    });
  ...
  static triggerNPCDiscussion(
    ...
    if (playerMessage && state.flags?.npcDiscussionActive) {
      const speaker =
        context.npcsInRoom[
          Math.floor(Math.random() * context.npcsInRoom.length)
        ];
    ...
    if (Math.random() < 0.2 && context.npcsInRoom.length >= 2) {
      dispatch({
        type: "SET_FLAG",
        payload: { flag: "npcDiscussionActive", value: true },
      });
      ...
      setTimeout(() => {
        dispatch({
          type: "SET_FLAG",
          payload: { flag: "npcDiscussionActive", value: false },
        });
        NPCTalk.any(
          topic.follow,
          "player",
