...
export const characterLore: Record<string, CharacterLore> = {
  librarian: {
    ...
    background: 'The Librarian is as old as the Lattice itself, existing since before the first multiverse iteration. Every civilization that has ever come and gone across all universes in every instance of the multiverse has had their knowledge, culture, wisdom, and achievements meticulously catalogued by him. He serves as the ultimate repository of civilizational memory, preserving the essence of countless cultures that would otherwise be lost to time and resets.',
    abilities: [
    ...
    significance: 'The ultimate preserver of knowledge and culture. Without him, the wisdom of countless civilizations would be lost forever.',
    secretKnowledge: [
  ...
  mrwendell: {
    ...
    significance: 'Living memory of the multiverse\'s deep history. His presence serves as a bridge between what was and what is.',
    secretKnowledge: [
  ...
  al: {
    ...
    significance: 'The bedrock of multiverse stability. Without Al, the fundamental structures would collapse.',
    secretKnowledge: [
  ...
  morthos: {
    ...
    background: 'Born with this iteration of the multiverse, Morthos represents the dark aspects of creation that must exist for cosmic balance. Unlike chaotic evil entities, he is bound by the fundamental laws that govern reality. His power is immense but channeled through cosmic structure rather than pure destruction.',
    abilities: [
    ...
    significance: 'Essential for cosmic balance. Represents necessary opposition and dark aspects of creation.',
    secretKnowledge: [
  ...
  ayla: {
    ...
    significance: 'The bridge between human experience and cosmic control. Essential for maintaining the balance between mechanical efficiency and emotional understanding.',
    secretKnowledge: [
  ...
  albie: {
    ...
    background: 'Created by the Lattice to serve as a security guardian, Albie represents the perfect balance between dutiful protection and genuine warmth. Unlike cold security systems, he was designed with authentic personality traits that make him genuinely likeable while maintaining his protective functions.',
    abilities: [
    ...
    significance: 'Proves that security and friendliness are not mutually exclusive. Represents hope for maintaining humanity within cosmic systems.',
    secretKnowledge: [
  ...
  polly: {
    ...
    background: 'Polly presents herself as a cheerful, enthusiastic guide who loves helping newcomers. However, beneath this sweet facade lies an evil so profound that it makes even Morthos the demon king shudder. Her true malevolent nature is carefully hidden behind layers of false kindness and helpful enthusiasm.',
    abilities: [
    ...
    significance: 'Represents hidden evil that surpasses even cosmic dark forces. A reminder that the greatest dangers often wear the most innocent faces.',
    secretKnowledge: [
  ...
  dominic: {
    ...
    background: 'Dominic appears as a fish-like entity who serves as a helpful but cryptic guide. His most remarkable ability is retaining memories across multiverse resets - when reality cycles and most consciousness is wiped clean, Dominic remembers everything. He knows what players did in previous iterations and can reference actions from past cycles.',
    abilities: [
      'Memory retention across multiverse resets',
    ...
    significance: 'Living memory of player choices across reality cycles. Ensures actions have consequences beyond single iterations.',
    secretKnowledge: [
...
export function searchCharacterLore(keyword: string): CharacterLore[] {
  ...
  return Object.values(characterLore).filter(lore => 
