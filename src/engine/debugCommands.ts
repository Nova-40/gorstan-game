  ...
  "debug reset encounter": {
    ...
    handler: (gameState: LocalGameState, dispatch?: Dispatch<GameAction>) => {
      if (dispatch) {
        dispatch({
          type: "SET_FLAG",
          payload: { flag: "hasMetMorthosAl", value: false },
        });
        dispatch({
          type: "SET_FLAG",
          payload: { flag: "metMorthos", value: false },
        });
        dispatch({
          type: "SET_FLAG",
          payload: { flag: "metAl", value: false },
        });
        dispatch({
          type: "SET_FLAG",
          payload: { flag: "firstEncounterComplete", value: false },
        });
      }
