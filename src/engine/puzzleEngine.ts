...
/**
 * Enhanced puzzle engine for world-class puzzle solving experience
 */
export class PuzzleEngine {
  ...
  /**
   * Initialize all puzzles in the game
   */
  ...
  /**
   * Get available puzzles for a room
   */
  ...
  /**
   * Validate solution based on puzzle type and components
   */
  ...
  /**
   * Validate logic puzzles (like Three Doors of Resolution)
   */
  ...
  /**
   * Validate pattern-based puzzles
   */
  ...
  /**
   * Register core game puzzles
   */
  private registerCorePuzzles(): void {
    // Three Doors of Resolution (Librarian Puzzle)
  ...
  /**
   * Register maze-specific puzzles
   */
  private registerMazePuzzles(): void {
    // Echo Navigation Puzzle
  ...
  /**
   * Register navigation puzzles
   */
  private registerNavigationPuzzles(): void {
    // Dimensional Crossing Navigation
