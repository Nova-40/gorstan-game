        ...
        responses: [
          {
            ...
            effects: [
              { type: "flag", key: "asked_ayla_identity", value: true },
            ],
    ...
    general: [
      {
        ...
        conditions: [
          { type: "trust", key: "trust", value: 5, operator: "greater" },
        ],
        priority: 8,
      },
      {
        ...
        conditions: [
          { type: "trust", key: "trust", value: 3, operator: "greater" },
        ],
        priority: 6,
      },
      {
        ...
        conditions: [
          { type: "trust", key: "trust", value: 2, operator: "less" },
        ],
        priority: 4,
      },
      {
    ...
    quest: [
      {
        ...
        conditions: [
          { type: "flag", key: "constitution_quest_active", value: true },
        ],
        priority: 9,
      },
      {
    ...
    special: [
      {
        ...
        conditions: [
          { type: "stat", key: "deathCount", value: 3, operator: "greater" },
        ],
        priority: 8,
      },
      {
        ...
        conditions: [
          { type: "stat", key: "resetCount", value: 5, operator: "greater" },
        ],
        priority: 8,
      },
    ],
  ...
  dominic: {
    ...
    general: [
      ...
      },
      {
        ...
        conditions: [
          { type: "stat", key: "resetCount", value: 2, operator: "greater" },
        ],
        priority: 8,
      },
    ],
...
function findMatchingDialogue(
  ...
  const validDialogues = dialogues.filter((dialogue) => {
    ...
    if (
      dialogue.oneTime &&
      state.flags?.usedDialogues?.[state.playerName || "unknown"]?.includes(
        dialogue.id,
      )
    ) {
      return false;
  ...
  validDialogues.sort(
    (a: DialogueNode, b: DialogueNode) => (b.priority || 0) - (a.priority || 0),
  );
    ...
    switch (effect.type) {
      ...
      case "trait":
        ...
        if (
          ...
          !state.traits.includes(effect.value)
        ) {
