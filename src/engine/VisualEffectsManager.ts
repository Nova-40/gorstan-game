...
export class VisualEffectsManager {
  ...
  public applyEffect(
    ...
    if (import.meta.env.DEV) {
      console.log(
        `[VisualEffectsManager] Applied effect: ${effectName}`,
        effectConfig,
      );
    }
  ...
  public clearAllEffects(preservePersistent: boolean = true): void {
    ...
    if (import.meta.env.DEV) {
      console.log(
        `[VisualEffectsManager] Cleared ${effectsToRemove.length} effects`,
      );
    }
  }
