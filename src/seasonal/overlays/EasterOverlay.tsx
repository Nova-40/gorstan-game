 ...
 * - ESC key handling
 */
export const EasterOverlay: React.FC<EasterOverlayProps> = ({
  isOpen,
  onClose,
}) => {
  ...
  return (
    <BaseDialog onClose={onClose} title="🐰 Easter Celebration">
      <div className="seasonal-content">
        ...
        <p className="mb-4">
          Spring has arrived in Gorstan! A time of renewal, discovery, and new
          beginnings. Like hidden Easter eggs waiting to be found, mysteries
          await your discovery throughout the game world.
        </p>
