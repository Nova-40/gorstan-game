 ...
 */
export const May13Overlay: React.FC<May13OverlayProps> = ({
  isOpen,
  onClose,
}) => {
  ...
  return (
    <BaseDialog onClose={onClose} title="🎂 May 13th">
      <div className="seasonal-content">
        ...
        <p className="mb-4">
          Today marks another year in the life of Gorstan's creator. What are
          the odds that you'd be playing on this very day? Suspiciously high,
          one might say...
        </p>
        <p className="mb-4">
