...
const DramaticWaitTransition: React.FC<DramaticWaitTransitionProps> = ({ onComplete }) => {
  ...
  return (
    <AnimatePresence>
      ...
      >
        {/* Tension Building Effect - Enhanced */}
        {phase === 'tension' && (
          <>
            <motion.div
        ...
        {/* Approaching Lorry Effect - More Intense */}
        {phase === 'approaching' && (
          <>
        ...
        {/* DRAMATIC SPLAT Effect */}
        {phase === 'splat' && (
          <>
            {/* Main splat explosion */}
            <motion.div
              className="absolute inset-0"
              initial={{ scale: 0, opacity: 0 }}
        ...
        {/* Text Content for Earlier Phases */}
