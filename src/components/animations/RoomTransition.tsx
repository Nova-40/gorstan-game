...
const RoomTransition: React.FC<RoomTransitionProps> = ({
  ...
  const [phase, setPhase] = useState<
    "start" | "transition" | "arrival" | "complete"
  >("start");
  ...
  useEffect(() => {
    ...
    const timeline = async () => {
      ...
      await new Promise((resolve) =>
        setTimeout(resolve, getTransitionDuration()),
      );
      ...
      case "chair_portal":
        return {
          ...
          transition: {
            ...
            y: -20,
            background:
              "conic-gradient(from 0deg, #00d4aa, #00a0b0, #005f73, #001219, #00d4aa)",
          },
    ...
    <AnimatePresence>
      ...
      >
        ...
        <motion.div
          ...
          transition={{
            duration:
              phase === "transition" ? getTransitionDuration() / 1000 : 0.3,
            ease: "easeInOut",
          }}
        >
          <motion.h2
