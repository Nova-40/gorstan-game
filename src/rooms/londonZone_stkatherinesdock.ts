...
const stkatherinesdock: Room = {
  ...
  events: {
    onEnter: [
      "activatePortalVisibility",
      "assessPublicAwareness",
      "stabilizeGateway",
    ],
  ...
  secrets: {
    ...
    perception_filter: {
      ...
      requirements: [
        "observe oblivious_tourists",
        "try_to_alert multiple people",
      ],
    ...
    new_york_connection: {
      ...
      rewards: [
        "transpacific_understanding",
        "location_significance_knowledge",
      ],
    },
  },
  ...
  customActions: {
    step_through_portal: {
      ...
      effects: [
        "transport_to_newyork",
        "experience_transdimensional_travel",
        "arrive_centralpark",
      ],
    },
    jump: {
      ...
      requirements: [],
      effects: [
        "dramatic_portal_entry",
        "transport_to_newyork",
        "arrive_centralpark_with_style",
      ],
    },
    test_tourist_awareness: {
      ...
      effects: [
        "confirm_perception_filter",
        "understand_camouflage",
        "realize_selection",
      ],
    },
    analyze_portal_energy: {
      ...
      effects: [
        "understand_portal_science",
        "detect_energy_signatures",
        "assess_safety",
      ],
    },
  },
