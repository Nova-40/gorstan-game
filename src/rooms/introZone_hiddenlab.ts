...
const hiddenlab: Room = {
  ...
  security: {
    ...
    alarmTriggers: [
      "attempt_to_reactivate_apparatus",
      "temporal_paradox_creation",
    ],
  ...
  secrets: {
    reset_attempts_log: {
      ...
      requirements: [
        "examine experimental_logs thoroughly",
        "analyze reality_apparatus",
      ],
    ...
    personal_message: {
      ...
      requirements: [
        "read psychic_paper_sign multiple times",
        "encounter reality_echo",
      ],
