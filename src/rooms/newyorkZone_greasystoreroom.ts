...
const greasystoreroom: Room = {
  ...
  events: {
    onEnter: [
      "assessAvailableItems",
      "activateChefGenerosity",
      "spawnChefIfAuthorized",
    ],
    onExit: ["recordItemsTaken", "thankChef"],
    onInteract: {
      greasy_napkin_with_plans: [
        "revealQuantumDiagrams",
        "recognizeLibrarianValue",
      ],
  ...
  secrets: {
    quantum_plans_significance: {
      ...
      requirements: [
        "study quantum diagrams thoroughly",
    ...
    chef_connections: {
      ...
      rewards: [
        "underground_network_understanding",
        "chef_background_knowledge",
      ],
    },
  },
  ...
  customActions: {
    ...
    thank_chef_mentally: {
      ...
      effects: [
        "gain_gratitude",
        "understand_network_value",
        "strengthen_chef_relationship",
      ],
    },
  },
};
