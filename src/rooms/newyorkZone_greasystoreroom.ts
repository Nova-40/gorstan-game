  ...
  npcs: [
{
      ...
      dialogue: {
        greeting: 'Take a look around! Anything here that\'s useful to you, just grab it. I believe in helping folks out.',
        help: 'That napkin might look gross, but sometimes the most valuable things come in unexpected packages. The batteries are fresh, and that coin... well, let\'s just say it found its way here.',
        farewell: 'Hope you found what you needed. Safe travels, and remember - good food brings good people together.',
        encouragement: 'Don\'t be shy! I meant what I said - help yourself to whatever\'s useful.',
      },
      spawnable: true,
