...
const burgerjoint: Room = {
  ...
  customActions: {
    place_correct_order: {
      ...
      effects: [
        "satisfy_order_requirement",
        "prepare_for_password",
        "receive_excellent_food",
      ],
    },
    give_password_aevira: {
      ...
      effects: [
        "gain_chef_authorization",
        "unlock_storeroom",
        "notify_albie_at_warehouse",
      ],
    },
    explore_storeroom: {
      ...
      effects: [
        "access_useful_items",
        "gain_travel_supplies",
        "complete_burger_joint_mission",
      ],
    },
  },
};
