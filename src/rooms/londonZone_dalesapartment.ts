...
const dalesapartment: Room = {
  ...
  secrets: {
    ...
    relationship_story: {
      ...
      requirements: [
        "examine all wall_photos",
        "study shared_calendar",
        "explore all rooms",
      ],
    ...
    hidden_remote_control: {
      ...
      requirements: [
        "search sofa cushions",
        "look_under_cushions on living_room_sofa",
      ],
  ...
  customActions: {
    ...
    appreciate_tidiness: {
      ...
      effects: [
        "understand_care_level",
        "appreciate_dedication",
        "feel_home_atmosphere",
      ],
    },
    piece_together_life: {
      description:
      ...
      effects: [
        ...
        "feel_emotional_connection",
        "appreciate_shared_life",
      ],
    },
    look_for_remote_control: {
      ...
      effects: [
        "find_hub_remote",
        "unlock_system_access",
        "gain_remote_control_item",
      ],
    },
    find_runbag: {
