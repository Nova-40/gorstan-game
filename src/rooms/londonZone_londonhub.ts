...
const londonhub: Room = {
  ...
  environmental: {
    ...
    hazards: [
      ...
      "unauthorized_travel_consequences",
    ],
  },
  ...
  secrets: {
    hidden_platform: {
      ...
      requirements: [
        "examine warning_signs thoroughly",
        "use reality_anchor_token",
      ],
    ...
    escalator_secret: {
      ...
      requirements: [
        "ride escalator multiple times",
        "examine transition point",
      ],
  ...
  customActions: {
    ...
    acquire_travel_pass: {
      ...
      requirements: [
        "communicate_with_overseer",
        "prove_dimensional_awareness",
      ],
