  ...
  npcs: [
{
      ...
      dialogue: {
        greeting: "Welcome, seeker. Few are permitted to walk among the Nine.",
        help: "Each shelf holds a key tome. Only when all are gathered may the pedestal be activated.",
        farewell: "Guard your mind, for knowledge here is both gift and burden.",
      },
      spawnable: true,
      spawnCondition: "player_places_tome_on_pedestal",
    }
  ],
