...
const latticehub: Room = {
  ...
  secrets: {
    ...
    great_plan_scope: {
      ...
      requirements: [
        "enter temporal_resonance_chamber",
        "interface with architect_console",
      ],
      rewards: [
        "cosmic_purpose_understanding",
        "multiversal_responsibility_acceptance",
      ],
    },
  ...
  customActions: {
    commune_with_lattice: {
      ...
      effects: [
        "unlock_quantum_magic",
        "gain_multiversal_awareness",
        "understand_true_purpose",
      ],
    },
    ...
    understand_great_plan: {
      ...
      requirements: [
        "temporal_resonance_chamber_entered",
        "great_plan_revealed",
      ],
      effects: [
        "cosmic_understanding",
        "purpose_clarity",
        "future_path_illuminated",
      ],
    },
  },
};
