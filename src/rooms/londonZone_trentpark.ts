...
const trentpark: Room = {
  ...
  secrets: {
    rune_meanings: {
      ...
      requirements: [
        "study carved_runes extensively",
        "use dimensional_compass",
      ],
    ...
    watcher_purpose: {
      ...
      requirements: [
        "acknowledge shadow_movements",
        "establish contact with watchers",
      ],
  ...
  customActions: {
    sit_in_chair: {
      ...
      effects: [
        "transport_to_reset_room",
        "trigger_reality_displacement",
        "begin_reset_sequence",
      ],
    },
    ...
    study_complete_rune_circle: {
      ...
      effects: [
        "unlock_runic_knowledge",
        "understand_portal_mechanics",
        "gain_reset_insight",
      ],
    },
  },
