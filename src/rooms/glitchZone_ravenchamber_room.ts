...
const ravenChamberRoom: Room = {
  ...
  interactables: {
    'console': {
      id: 'console',
      name: 'AI Console',
      description: 'An ancient AI console with holographic displays and a palm scanner. The screen flickers with fragments of corrupted data.',
      commands: ['interact console', 'access archive', 'activate console', 'touch console'],
      responses: {
        examine: 'The console is ancient but functional. Holographic displays flicker with fragments of corrupted data. A palm scanner glows faintly blue.',
        use: 'You place your hand on the scanner. The console responds with a warm blue glow.',
        interact: 'The console screen blazes to life. Ancient systems boot with crackling static...'
      }
    },
    'screens': {
      id: 'screens',
