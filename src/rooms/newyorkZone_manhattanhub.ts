...
const manhattanhub: Room = {
  ...
  events: {
    onEnter: [
      "checkMedallionStatus",
      "activateHubSecurity",
      "assessClearanceLevel",
    ],
  ...
  environmental: {
    ...
    hazards: [
      "dimensional_displacement_risk",
      "unauthorized_access_consequences",
    ],
  },
  ...
  secrets: {
    hub_puzzle_solution: {
      ...
      requirements: [
        "medallion_verified",
        "study dimensional_displays thoroughly",
      ],
    ...
    dimensional_map_secrets: {
      ...
      requirements: [
        ...
        "examine dimensional_map carefully",
      ],
  ...
  customActions: {
    ...
    solve_hub_transit_puzzle: {
      ...
      effects: [
        "unlock_next_zone_access",
        "gain_transit_mastery",
        "complete_hub_challenge",
      ],
    },
    attempt_unauthorized_access: {
      ...
      requirements: [],
      effects: [
        "trigger_albie_expulsion",
        "return_to_central_park",
        "receive_stern_warning",
      ],
    },
  },
};
